...
public class AddFriendBD {
	 ...
	 * @param idA Le id du premier utilisateur.
	 * @param idB Le id du second utilisateur.
	 * @return Retourne true si l'ajout a bien été effectué, false sinon.
	 * @throws SQLException
	 * @throws ClassNotFoundException
	 */
	public boolean addFriend(int idA, int idB) throws SQLException, ClassNotFoundException {
		Connection connexion=null;
		PreparedStatement preparedStatement=null;
		boolean ok=false;
		...
		preparedStatement = connexion.prepareStatement( "INSERT INTO friends (idFriendA,idFriendB) VALUES(?,?);");
		preparedStatement.setInt( 1, idA );
		preparedStatement.setInt( 2, idB );
