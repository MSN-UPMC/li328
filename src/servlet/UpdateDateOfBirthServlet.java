...
import services.UpdateDateOfBirthServices;


/**
 * Servlet implémentant la class UpdateDateOfBirthServlet
 * @author Mag-stellon Nadarajah & Kamalraj Muruganathan
 *
 */
public class UpdateDateOfBirthServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		UpdateDateOfBirthServices cus = new UpdateDateOfBirthServices(map);
