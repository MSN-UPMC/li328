...
import services.CheckLikeInCommentServices;

import com.mongodb.MongoException;


public class CheckLikeInCommentServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		CheckLikeInCommentServices cus = new CheckLikeInCommentServices(map);
